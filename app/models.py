...
class TimeEntry(TimestampMixin, Base):
    ...
    def is_paused(self) -> bool:
        return not self.is_deleted and self.end_time is None and self.paused_at is not None

    @property
    def is_running(self) -> bool:
        return not self.is_deleted and self.end_time is None and self.paused_at is None
